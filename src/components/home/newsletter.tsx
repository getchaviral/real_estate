          ...
          <Card className="overflow-hidden border-border/70 bg-card/80">
            <CardContent className="grid gap-6 p-8 md:grid-cols-[1.1fr_0.9fr] md:p-10 lg:p-12">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">Get first access to curated launches, price drops, and smart investment alerts.</h2>
                <p className="mt-4 max-w-xl text-lg leading-8 text-muted-foreground">Receive handpicked opportunities, market updates, and neighborhood insights tailored to your buying goals.</p>
              </div>
